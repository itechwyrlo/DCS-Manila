<?php
  ...
  if (isset($_POST["submit"])) {
    if (!empty($_FILES["upload"]["name"]) && is_uploaded_file($_FILES["upload"]["tmp_name"])) {
                  ...
                  <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="profile-container mt-2 mb-2">
                        <img id="avatar" name="avatar" src="<?php echo $avatar_path; ?>" alt="" class="rounded-circle img-thumbnail" width="130" height="130" style="cursor: pointer; object-fit: cover;">
