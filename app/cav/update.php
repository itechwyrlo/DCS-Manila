<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $rrmObj = new RrmRecord();
    $rrmObj->setStatus($_GET["record_id"], $status["status_id"]);
    $trackObj = new RrmRecordTracking();
    $trackObj->addRecord($_GET["record_id"], $remarks ?: "Status updated to " . $status["name"] . " (Certification, Authentication and Verification).", $_SESSION["account_id"] ?? null);
